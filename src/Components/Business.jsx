  ...
  return (
    <div className={`flex flex-row p-6 rounded-[20px] ${index!== features.length -1 ? 'mb-6':'mb-0'} feature-card`}>
      ...
      <div className="flex-1 flex flex-col ml-3">
        <h3 className="font-poppins font-semibold text-white text-[18px] leading-[23px] mb-1">{title}</h3>
        <p className="font-poppins font-normal text-dimWhite text-[14px] leading-[23px]">{content}</p>
      </div>
    </div>
  )
}
